...
const StudentRefs = ({ handleChange, handleUpload, page, btnText }) => {
  return (
    <Container className={`form-four animate__animated animate__fadeIn`}>
      ...
      <section className='section'>
        <Form.Row>
          ...
          <Col>
            <Form.Group>
              <Form.Label className='sups-refs-labels'>اسم المحكم</Form.Label>
          ...
          <Col>
            <Form.Group controlId='specialization-t'>
              <Form.Label className='sups-refs-labels'>تخصص المحكم</Form.Label>
          ...
          <Col>
            <Form.Group controlId='cancelationDate-t'>
              <Form.Label className='sups-refs-labels'>حالة التقرير</Form.Label>
          ...
          <Col className='del-col'>
            ...
            <Button type='button'>مسح المحكم</Button>
          </Col>
        </Form.Row>
      </section>
    </Container>
